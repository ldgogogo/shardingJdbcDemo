//package com.ld.mpdemo.base.framework.mybatisplus;
//
...
//                Map<String, DataSource> dataSourceMap1 = ((MasterSlaveDataSource) masterSlaveDataSource).getDataSourceMap();
//                dataSourceMap.putAll(dataSourceMap1);
